...
Button {
    ...
    contentItem:Text {
        id:label;text:root.text;textFormat:Text.PlainText
        color:root.enabled?(root.primary?Model.ink:root.tint):Model.muted
        font.family:"monospace";font.pixelSize:root.compact?11:12;font.weight:Font.DemiBold
    ...
    background:Rectangle {
        ...
        radius:4;opacity:root.enabled?1:0.45
    }
