...
- 19 QtQuick cases (21 results including setup/cleanup): keyboard actions, input focus, note save, draft preservation, separate demo/live drafts, literal markup, hidden/empty/error states, compact layout, help, and stopped animation when closed. Runtime QML warnings fail these tests. `qmllint` reports no warnings for the portable view and components.
